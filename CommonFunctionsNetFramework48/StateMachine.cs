...
namespace RICOMPANY.CommonFunctions.StateMachine
{
    ...
    public class StateMachine
    {
        ...
        //показать контролы
        public void addShowAction(int stateId, ActionOnEnterOrLeaveEnum enterOrLeave, List<Control> targetControls)
        {
